        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp mx-auto" data-wow-delay="0.5s">
                    <h2 class="mb-4 text-center">Réinitialiser Mon Mot De Passe</h2>
                    <div class="row g-3">
                        <div class="col-sm-12">
                        ...
                        <div class="col-12 text-center">
                            <button class="btn btn-primary w-100 py-3" type="submit">Envoyer le lien de réinitialisation</button>
                        </div>                        
