            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="/accouplement" class="nav-item nav-link">Accouplement</a>
...
{{ $demandes }}
 <!-- Service Start -->
 <div id="services" class="container-fluid container-service py-1">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">ANIMAL+</h1>
                <p class="mb-5">Bienvenue {{ auth::user()->name }} dans votre espace Propriétaires</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <div class="icon-box-primary mb-4">
                            <i class="bi bi-arrow-through-heart-fill text-dark"></i>
                        </div>
                        <h5 class="mb-3">{{ $demandes }}</h4>
                            <p class="mb-4">Match D'accouplement En Attente</p>
                        <a class="btn btn-light px-3" href="/demande">Consulter<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
    ...
    @else 
    <h1>Vous devez payer votre Offre Pour continuer a utiliser notre plateform</h1>
    <a href="/" class="btn btn-primary w-100 py-3">revenir vers l'accueil</a>
    @endif
