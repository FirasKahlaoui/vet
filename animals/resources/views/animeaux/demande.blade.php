...
<h2 class="text-center mb-3">Demande De {{ $demande->name }}</h2>
...
<h4 class="text-center mb-3">Informations De L'animal</h4>
    ...
    <div class="service-item" style="height: 500px;">
     ...
     <img width="210" height="210" src="{{ asset('storage/animal-images/' . $demande->image) }}" alt="Image de l'animal">
        </div>
        <h5 class="mb-3">{{ $demande->nom }}</h5>
            <p class="mb-4">Type: {{ $demande->type }}</p>
            <p class="mb-4">Race: {{ $demande->race }}</p>
            <p class="mb-4">Sex: {{ $demande->sex }}</p>
            <p class="mb-4">Date de naissance: {{ $demande->date_naissance }}</p>
...
<h4 class=" text-center mb-3">Informations Du Propriétaire</h4>
    ...
    <div class="service-item" style="height: 500px;">
        ...
        <h5 class="mb-3">{{ $demande->name }}</h5>
            <p class="mb-4"><b> Email:</b> {{ $demande->email }}</p>
            <p class="mb-4"><b> Téléphone:</b> {{ $demande->tel }}</p>
            <p class="mb-4"><b> Ville :</b> {{ $demande->ville }}</p>
            <p class="mb-4"><b> Message de {{ $demande->name }} pour ce match :</b> {{ $demande->message }}</p>
        <!-- <a class="btn btn-light px-3" href="">Consulter<i class="bi bi-chevron-double-right ms-1"></i></a> -->
    </div>
</div>
<div class="col-lg-4 col-md-6 mx-auto wow fadeInUp" data-wow-delay="0.1s">
<h4 class=" text-center mb-3">Action</h4>
<button class="btn btn-success" type="submit">Matcher</button>
<button class="btn btn-danger" type="submit">Réfuser</button>
</div>
