            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="/mesanimeaux" class="nav-item nav-link active">Mes Animeaux</a>
                        <a href="#services" class="nav-item nav-link">Marketplace</a>
...
@endif
    ...
    <div class="container-fluid py-5">
        <div class="container">
        <form method="POST" action="{{ route('store.animal') }}" enctype="multipart/form-data">
                    @csrf
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp mx-auto" data-wow-delay="0.5s">
                    <h2 class="mb-4 text-center">Enregistrer Un Animal</h2>
                    <div class="row g-3">
                    <div class="col-sm-6">
                            <div class="form-floating">
                            <input type="text" class="form-control" id="email" placeholder="Votre Nom" name="nom" :value="old('nom')" required autofocus autocomplete="name" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <select class="form-select" id="type" name="type" :value="old('type')" required>
                                    <option selected value="">Choisir Le Type De Votre Animal</option>
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        <div class="col-sm-12">
                            ...
                            <select class="form-select" id="race" name="race" :value="old('race')" required>
    <!-- Options de race seront ajoutées dynamiquement -->
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    ...
                    <div class="col-sm-6">
                            <div class="form-floating">
                                <select class="form-select" id="type" name="sex" :value="old('sex')" required>
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        ...
                        <div class="col-sm-12">
                            <div class="form-floating">
                            <input type="date" class="form-control" id="tel" placeholder="votre Matricule Fiscale" name="date_naissance" :value="old('date_naissance')" required autofocus />
                    ...
                    @enderror
                        ...
                        <div class="col-sm-12">
                            ...
                            <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" required>
                                <label for="mobile">choisir une image</label>
                            </div>
                        </div>
                        @error('image')
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
    ...
    typeDropdown.addEventListener('change', function() {
        ...
        var url = '/get-races?type=' + selectedType;
