...
<body>
    ...
    <div class="container-fluid py-5">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp mx-auto" data-wow-delay="0.5s">
                    ...
                    <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="email" placeholder="Votre Nom" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                                <select class="form-select" id="type" name="type" :value="old('type')" required>
                                    <option selected value="médecin">Propriétaire</option>
                                    <option value="médecin">Médecin</option>
                                    <option value="médecin">Clinique</option>
                                    <option value="médecin">Boutique</option>
                                </select>
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        <div class="col-sm-12">
                            <div class="form-floating">
                            <input type="email" class="form-control" id="email" placeholder="Your Email" name="email" :value="old('email')" required autofocus />
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        ...
                        <div class="col-sm-6">
                            <div class="form-floating">
                            <input type="number" class="form-control" id="tel" placeholder="votre Matricule Fiscale" name="tel" :value="old('tel')" required autofocus />
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    ...
                    <div class="col-sm-6">
                            <div class="form-floating">
                            <select class="form-select" id="ville" name="ville" :value="old('ville')" required>
         ...
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        ...
                        <div class="col-sm-12">
                            <div class="form-floating">
                            <input type="password" class="form-control" id="password" placeholder="Mot de passe" name="password" required autocomplete="new-password" />
                                <label for="mobile">Choisir un Mot De Passe</label>
                            </div>
                        </div>
                        @error('password')
         <div class="alert alert-danger" role="alert"> {{ $message }} </div>
                    @enderror
                        ...
                        <div class="col-sm-12">
                            <div class="form-floating">
                            <input type="password" class="form-control" id="password" placeholder="Mot de passe" name="password_confirmation" required autocomplete="new-password" />
                            <label for="mobile">Confirmer Le Mot De Passe</label>
                            </div>
                        </div>
        ...
        <h5 class="mb-4 text-center">Vous avez Un Compte ? <a href="/connexion" class="nav-item nav-link ">Se Connecter</a></h5>
        </div>
    </div>
    <!-- form end -->
